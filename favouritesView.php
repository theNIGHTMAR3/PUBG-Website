  ...
  <main>
   ...
   <section id="content">
		<form method="post" action="">
			...
			<br/><br/>
			<input type="submit" value="Usuń zaznaczone zdjęcia z ulubionych"/>
		</form>

	   	   <div class="linkDiv"><a class="link" href="galleryView.php"><h3>Wszystkie zdjęcia</h3> </a></div>

	      	<?php  
	if($page > 1){               //inne strony
		echo '<div class="linkDiv right"><a class="link" href="?page=' . $prev . '"<h3>Poprzednia strona</h3> </a></div>';
		if($page * $pageSize < $totalFav) {
